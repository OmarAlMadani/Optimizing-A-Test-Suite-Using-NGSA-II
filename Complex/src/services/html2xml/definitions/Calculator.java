    ...
    extends Service
{
    ...
    private final static Logger logger = Logger.getLogger(services.Calculator.class.getName());

    static {
        URL url = null;
        try {
            URL baseUrl;
            baseUrl = services.Calculator.class.getResource(".");
    ...
    public CalculatorSoap getCalculatorSoap() {
        return super.getPort(new QName("http://localhost:11305/CalculatorService/Calculator", "CalculatorSoap"), CalculatorSoap.class);
    }
    ...
    public CalculatorSoap getCalculatorSoap(WebServiceFeature... features) {
        return super.getPort(new QName("http://localhost:11305/CalculatorService/Calculator", "CalculatorSoap"), CalculatorSoap.class, features);
    }
    ...
    public CalculatorSoap getCalculatorSoap12() {
        return super.getPort(new QName("http://localhost:11305/CalculatorService/Calculator", "CalculatorSoap12"), CalculatorSoap.class);
    }
    ...
    public CalculatorSoap getCalculatorSoap12(WebServiceFeature... features) {
        return super.getPort(new QName("http://localhost:11305/CalculatorService/Calculator", "CalculatorSoap12"), CalculatorSoap.class, features);
    }
    ...
    public CalculatorHttpGet getCalculatorHttpGet() {
        return super.getPort(new QName("http://localhost:11305/CalculatorService/Calculator", "CalculatorHttpGet"), CalculatorHttpGet.class);
    }
    ...
    public CalculatorHttpGet getCalculatorHttpGet(WebServiceFeature... features) {
        return super.getPort(new QName("http://localhost:11305/CalculatorService/Calculator", "CalculatorHttpGet"), CalculatorHttpGet.class, features);
    }
    ...
    public CalculatorHttpPost getCalculatorHttpPost() {
        return super.getPort(new QName("http://localhost:11305/CalculatorService/Calculator", "CalculatorHttpPost"), CalculatorHttpPost.class);
    }
    ...
    public CalculatorHttpPost getCalculatorHttpPost(WebServiceFeature... features) {
        return super.getPort(new QName("http://localhost:11305/CalculatorService/Calculator", "CalculatorHttpPost"), CalculatorHttpPost.class, features);
    }
